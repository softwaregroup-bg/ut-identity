...
BEGIN TRY
    ...
    IF @UserID IS NULL
    BEGIN
	    --INSERT INTO errorLog.BusinessErrorLog(ErrorCode, ErrorInfo, [Object], Params)
     --   SELECT '4010', 'Invalid Credentials', 'LoginUser', 'userName: '+ @username +' password: '+ @password + ' portName: '+ @portName
    ...
    BEGIN
        --INSERT INTO errorLog.BusinessErrorLog(ErrorCode, ErrorInfo, [Object], Params)
        --SELECT '4013', 'This Credential Is Locked', 'LoginUser', 'userName: '+ @username +' password: '+ @password + ' portName: '+ @portName
    ...
    BEGIN
		...
		BEGIN
			--INSERT INTO errorLog.BusinessErrorLog(ErrorCode, ErrorInfo, [Object], Params)
			--SELECT '4012', 'Wrong Password', 'LoginUser', 'userName: '+ @username +' password: '+ @password + ' portName: '+ @portName
...
BEGIN CATCH
    ...
    EXEC dbo.ErrorInfoGet @errorInfo OUTPUT
        
    INSERT INTO dbo._ErrorLog(ErrorInfo, Params)
